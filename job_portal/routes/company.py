...
from job_portal.model import Achievements, Application, Application1, Certification, Company, Education, Experience, Job, Job1, JobseekerResume, Project, Publications, Reference, Resume
from login.models import CompanyInCharge, OnlineStatus, UniversityInCharge
