from job_portal.model import Achievements, Application, Application1, Certification, College, Company, Education, Experience, Job, Job1, NewUserEnquiry, Objective, Project, Publications, Reference, Resume, SavedJobForNewUser
