...
from login.routes import answer_routes, college_routes, company_routes, admission_review_routes, consultant_routes, contacts_routes, get_all_answers_routes, get_questions_routes, jobseeker_routes, new_user_routes, question_routes, subscriber1_routes, subscriber_routes
